      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            >
              <DialogPanel className={`relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all w-full ${widthClass} my-8 max-h-[90vh] flex flex-col border border-gray-100`}>
                {/* Sticky Header */}
